...
Zone.__load_patch('nativescript_observable_events', (g, z, api) => {
    api.patchNativeScriptEventTarget(g, api, [Observable, Observable.prototype, View, View.prototype]);
});
Zone.__load_patch('nativescript_xhr_events', (g, z, api) => {
...
Zone.__load_patch('nativescript_mainThreadify', (global, zone, api) => {
    api.patchMethod(Utils, 'mainThreadify', (delegate, delegateName, name) => function (self, args) {
...
Zone.__load_patch('nativescript_executeOnMainThread', (global, zone, api) => {
    api.patchMethod(Utils, 'executeOnMainThread', (delegate, delegateName, name) => function (self, args) {
        const callback = args[0];
...
Zone.__load_patch('nativescript_dispatchToMainThread', (global, zone, api) => {
    api.patchMethod(Utils, 'dispatchToMainThread', (delegate, delegateName, name) => function (self, args) {
        const callback = args[0];
...
Zone.__load_patch('nativescript_showModal', (global, zone, api) => {
    api.patchMethod(View.prototype, 'showModal', (delegate, delegateName, name) => function (self, args) {
        if (args.length === 2) {
