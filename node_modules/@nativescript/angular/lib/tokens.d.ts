...
export declare const PREVENT_CHANGE_EVENTS_DURING_CD: InjectionToken<boolean>;
export declare const PREVENT_SPECIFIC_EVENTS_DURING_CD: InjectionToken<string[]>;
