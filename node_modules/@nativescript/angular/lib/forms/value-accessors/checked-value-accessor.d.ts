...
export declare class CheckedValueAccessor extends BaseValueAccessor<Switch> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<CheckedValueAccessor, "Switch[ngModel],Switch[formControlName],Switch[formControl],switch[ngModel],switch[formControlName],switch[formControl]", never, {}, {}, never, never, false, never>;
}
